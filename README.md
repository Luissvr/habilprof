...
Este es el proyecto HabilProf, un sistema desarrollado en Laravel que permite gestionar el proceso de habilitaciones profesionales, incluyendo la sincronización automática (R1) con un módulo externo (Servidor_UCSC) y el posterior ingreso, actualización.
