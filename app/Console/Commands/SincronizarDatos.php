...
use Exception;                           // Para R1.8: Capturar cualquier error (ejemplo: BD no disponible)
...
class SincronizarDatos extends Command
{
    ...
    private function sincronizarAlumnos()
    {
        ...
        foreach ($alumnosExternos as $externo) {
            ...
            // 'updateOrCreate' es una función entregada por Laravel Eloquent:
